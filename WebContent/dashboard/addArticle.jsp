		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					<li><a href="#">文章管理 <span class="sr-only">(current)</span></a>
					</li>
					<li class="active"><a href="#">增加文章</a></li>
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<!-- 
				 ...
				 -->
				<form class="form-horizontal" role="form" action="doAddArticle.jsp" method="post">
