	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">
			...
			<div id="navbar" class="navbar-collapse collapse">
				...
				<form class="navbar-form navbar-right" method="post" action="<%=contextPath%>/ArticleController?op=queryLike">
					<input type="text" class="form-control" placeholder="Search..." name="articleLike" value="<%=request.getAttribute("articleLike")==null?"":request.getAttribute("articleLike")%>">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				...
				--%>
					<li class="active"><a href="${pageContext.request.contextPath}/ArticleController?op=query">文章管理 <span class="sr-only">(current)</span></a>
					</li>
					...
					<table class="table table-striped table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td><button class="btn btn-success">修改</button><a href="javascript:delFunction(<%=article.getArticleId()%>)"><button  class="btn btn-danger">删除</button></a></td>
							</tr>
